    ...
    public class EmployerController : Controller
    {
        ...
        public ActionResult ApplicationApprove(int id,int aid)
        {
            try
            {
                ...
                {
                    TempData["Message"] = "Đơn ứng tuyển đã được cập nhận";
                }
        ...
        public ActionResult ApplicationReject(int id,int aid)
        {
            try
            {
                ...
                {
                    TempData["Message"] = "Đơn ứng tuyển bị từ chối";
                }
                return RedirectToAction("Applications",new {id=aid});
            }
            catch (Exception ex)
        ...
        public ActionResult ChangePassword(string oldPassword, string newPassword)
        {
            try
            {
                ...
                {
                    TempData["Message"] = "Mật khẩu đã thay đổi";
                }
                else
                {
